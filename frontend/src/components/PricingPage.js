      ...
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 text-center">
          <div className="glass-card p-8 max-w-2xl mx-auto">
            <h3 className="text-2xl font-bold text-white mb-4">Join Our Professional Community</h3>
            <p className="text-slate-300 mb-6">
              Connect with thousands of laundromat owners, operators, and industry professionals. 
              Get insider tips, ask questions, and share your experiences.
            </p>
            <motion.a
              href="https://facebook.com/groups/thelaundromat"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center space-x-3 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white px-8 py-4 rounded-xl font-semibold text-lg shadow-2xl hover:shadow-blue-500/25 transition-all duration-300"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
