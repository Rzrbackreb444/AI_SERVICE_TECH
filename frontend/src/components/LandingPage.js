...
const LandingPage = ({ onOpenAuth }) => {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
            ...
            <div className="mb-8 sm:mb-12">
              ...
              >
                ...
                <motion.div
                  ...
                  className="space-y-2"
                >
                  <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-slate-300 font-medium">Elite Location Intelligence Platform</p>
      ...
      {/* Case studies moved to dedicated pages - focus on core value proposition */}
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              >
                ...
                <span>Start Location Analysis</span>
              </Link>
            </motion.div>
        ...
        <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-slate-400 text-sm">
                <li><Link to="/analyze" className="hover:text-white transition-colors">Location Intelligence</Link></li>
                <li><Link to="/case-study/vista-laundry" className="hover:text-white transition-colors">Success Stories</Link></li>
                <li><a href="mailto:nick@laundryguys.net" className="hover:text-white transition-colors">Contact</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-slate-400 text-sm">
                ...
                <li><a href="mailto:nick@apiuniversity.com" className="hover:text-white transition-colors">Consultation</a></li>
              </ul>
            </div>
          ...
          <div className="pt-8 border-t border-slate-700 text-center">
            <p className="text-slate-400 text-sm mb-4">
              © 2024 LaundroTech. All rights reserved. Operating System for the Laundromat Industry.
            </p>
