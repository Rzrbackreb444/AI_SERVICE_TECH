...
import LocationIntelligenceModule from './components/LocationIntelligenceModule';
      ...
      <BrowserRouter>
        <div className="App min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
          ...
          <Routes>
            ...
            <Route 
              path="/" 
              element={isAuthenticated ? <EnterpriseDashboard /> : <SuperiorLandingPage onOpenAuth={openAuthModal} />} 
            />
            <Route 
              path="/pricing" 
