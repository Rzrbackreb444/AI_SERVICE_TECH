        ...
        <body>
            <div class="container">
                ...
                <div class="content">
                    ...
                    <div class="cta">
                        <a href="https://washer-analytics.preview.emergentagent.com/analyze" class="button">
        ...
        <body>
            <div class="container">
                ...
                <div class="results">
                    ...
                    <div class="cta">
                        <a href="https://washer-analytics.preview.emergentagent.com/history" class="button">
        ...
        <body>
            <div class="container">
                ...
                <div style="text-align: center; margin: 30px 0;">
                    ...
                    <a href="https://washer-analytics.preview.emergentagent.com/facebook-group" style="display: inline-block; background: linear-gradient(135deg, #3B82F6, #06B6D4); color: white; padding: 12px 24px; text-decoration: none; border-radius: 8px; font-weight: bold;">
            ...
            <body>
                <div class="container">
                    ...
                    <div class="content">
                        ...
                        <p>In the meantime, you might find answers in our <a href="https://washer-analytics.preview.emergentagent.com/support" style="color: #3B82F6;">FAQ section</a>.</p>
